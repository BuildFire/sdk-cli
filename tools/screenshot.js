        ...
        function snap(res, callback) {
            ph.createPage(function (page) {
                ...
                page.open(options.url, function (status) {
                    ...
                    console.log(options.url + "#" + options.hash, " opened? ", status);

                    page.evaluate("location.hash = '/pushGroups';", function (err) {});

                    if (options.hash) {
                        page.evaluate("location.hash = '" + options.hash + "';", function (err) {

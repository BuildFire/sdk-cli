...
(function () {
    ...
    var downloadRepo = function (repoName, url) {
        ...
        var request = http.get(url, function (response) {
            ...
            file.on('finish', function () {
                console.info('Downloading zip completed.');
                file.close(function () {
                    ...
                    console.info('move files to root...');
    ...
    switch (command) {
        case "install":
            if (argv.p) {
                console.info("installing " + argv.p + " plugin");
                downloadRepo(argv.p);
            }
            else {
                console.info("installing sdk");
                downloadRepo('sdk');
            }
            break;
        case "update":
            console.info("updating sdk");
            downloadRepo('sdk');
            break;
        default :
